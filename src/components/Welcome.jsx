    ...
    <>
      <section id="welcome" ref={welcomeContainerRef}>
        ...
        <div className="small-screen">
          ...
          <br />
          <a href="https://me.thecodingant.in/" target="_blank" rel="noopener noreferrer" className="flex-center text-blue-100">For Mobile Devices visit here</a>
        </div>
      </section>
